"""
Django settings for jade_perfume project.
...
SECRET_KEY = 'django-insecure-1zu7v+bg-yx-kupdmxnnl6s-tf3$9cj%oxgt$ihipe!@y-@by*'
...
ROOT_URLCONF = 'jade_perfume.urls'
...
WSGI_APPLICATION = 'jade_perfume.wsgi.application'
